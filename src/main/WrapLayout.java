/**
 * Credit for almost all of this layout goes to Rob Camick, the article on this
 ...
 * 
 * This class has been slightly modified to include the hgap in the calculation 
 *  for whether or not a new row needs to be added.
 */
package main;
...
public class WrapLayout extends FlowLayout
{
    ...
    private Dimension layoutSize(Container target, boolean preferred)
    {
        synchronized (target.getTreeLock())
        {
            ...
            //  container has not yet been calculated so lets ask for the
            //  maximum.

            int targetWidth = target.getSize().width;
            Container container = target;

            while (container.getSize().width == 0 && container.getParent() != 
                null)
            {
